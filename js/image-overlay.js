...
export class ImageOverlay {
    ...
    initializeCenterMarker(position, addToMap = true) {
        const centerIcon = L.divIcon({
            ...
            html: '<div style="width: 8px; height: 8px; background-color: #32d74b; border: 1.5px solid #ffffff;"></div>',
            iconSize: [12, 12],
            iconAnchor: [6, 6]
        });
    ...
    createDragHandles(bounds) {
        ...
        corners.forEach((corner, index) => {
            const handleIcon = L.divIcon({
                ...
                html: '<div class="drag-handle-pulse" style="width: 8px; height: 8px; background-color: #32d74b; border: 1.5px solid #ffffff;"></div>',
                iconSize: [12, 12],
                iconAnchor: [6, 6]
            });
